...
object docSimilarityV2 {
  ...
  def main(args: Array[String]) {
    ...
    //bulid environment
    val spark = SparkSession.builder.appName("LDA: docSimilarityV2").getOrCreate()
    ...
    */
    ...
    val ldaMat = ldaModel.describeTopics(maxTermsPerTopic = 5)
    val ds2 = ldaModel.transform(ds1)
    ds2.printSchema()
    ds2.show(2)
