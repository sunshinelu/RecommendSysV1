...
import com.ecloud.Inglory.RecommendSys.alsDataProcessedV4.{Schema2, Schema1, LogView, Schema}
...
object cnxh {
  ...
  def main(args: Array[String]) {
    ...
    //bulid environment
    val spark = SparkSession.builder.appName("cainixihuan").getOrCreate()
