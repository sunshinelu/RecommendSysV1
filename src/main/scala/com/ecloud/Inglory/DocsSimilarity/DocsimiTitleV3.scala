 ...
 * 在DocsimiTitleV2的基础上，在计算文章相似性之前，使用标题、column_id、文章时间对文章进行除重
 *
 * spark-shell下测试：
...
*/
    ...
    val sparkConf = new SparkConf().setAppName(s"ylzx_xgwz_DocsimiTitleV3") //.setMaster("local[*]").set("spark.executor.memory", "2g")
