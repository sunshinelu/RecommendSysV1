...
import org.apache.hadoop.hbase.client.{ResultScanner, Put, HBaseAdmin}
 ...
 * 计算近7天的文章与近一年文章相似性，然后把结果分别存到ylzx_xgwz_temp和ylzx_xgwz中
 * 其中ylzx_xgwz_temp表每次存储之前都要清空
 *
...
*/
    ...
    val sparkConf = new SparkConf().setAppName(s"ylzx_xgwz_DocsimiTitleV4") //.setMaster("local[*]").set("spark.executor.memory", "2g")
...
//    cal.add(Calendar.MONTH, -N) //获取N月或N月后的时间，-2为2月前
    ...
    3. get data
     */
    val ylzxRDD = DocsimiUtil.getYlzxYRDD2(ylzxTable, 1, sc)
